	    ...
	    public static List<Student> GetListStudents()
	    {
            ...
            using (StreamReader reader = new StreamReader(pathFileWithStudents))
            {
                ...
                while (true)
                {
                    ...
                    int randomFacultyNumber = random.Next(100000, 101000);
                    ...
                    students.Add(new Student(words[1], words[2], randomAge, randomFacultyNumber.ToString(), randomPhoneNumber.ToString(),
                                words[3], marks, words[7]));
                    i++;
                    j++;
                }
            }
